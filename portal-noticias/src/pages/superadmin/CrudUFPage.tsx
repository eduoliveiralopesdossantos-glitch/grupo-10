      ...
      <div className="admin-layout">
        ...
        <main className="admin-main">
          <div className="admin-page-header">
            <div><h1 className="page-title">Unidades Federativas</h1></div>
            <Button variant="primary" onClick={() => nav("/admin/ufs/nova")}>+ Novo(a) UF</Button>
          </div>
          <div className="filter-bar"><SearchBar value={search} onChange={setSearch} placeholder="Buscar..." /></div>
          <div className="table-wrap">
            <table className="data-table">
              <thead><tr><th>ID</th><th>Sigla</th><th>Nome</th><th>Cidades</th><th>Ações</th></tr></thead>
              <tbody>
